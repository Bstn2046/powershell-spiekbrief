...
<title>PowerShell Spiekbrief — Snel</title>
<style>
    ...
    <li>Combineer met AD-cmdlets voor krachtige automatisering (gebruikersbeheer, logging, inventarisatie).</li>
      ...
      <aside>
        ...
        <div class="card" style="margin-top:12px">
          ...
          <div class="muted">Deze spiekbrief verwijst naar gezaghebbende docs en handige quick refs.</div>
          <ul>
